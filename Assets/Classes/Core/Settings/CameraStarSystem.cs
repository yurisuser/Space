namespace Settings
{
	public struct CameraStarSystem
	{
		...
		public readonly static float STEP_ZOOM = 1000f;
		public readonly static float STEP_SMOOTH = 50f;
		public readonly static float MAX_DELTA_SMOOTH = 1;
		public readonly static float PARALAX_SCALE_FACTOR = 7;
	}
}
